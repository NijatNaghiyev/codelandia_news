...
List<AppCategories> categories = [
  ...
  AppCategories('Business', 'assets/images/business.png'),
  AppCategories('Weather', 'assets/images/weather.png'),
  AppCategories('Science', 'assets/images/science.png'),
  AppCategories('Health', 'assets/images/health.png'),
  AppCategories('Sports', 'assets/images/sports.png'),
];
